...
TEST_PASSWORD = os.getenv("TEST_PASSWORD", "doe")
TEST_PASSWORD_MISMATCH = os.getenv("TEST_PASSWORD_MISMATCH", "janedoe")
TEST_PASSWORD_INVALID = os.getenv("TEST_PASSWORD_INVALID", "AbCdEf!123")
TEST_PASSWORD_INVALID2 = os.getenv("TEST_PASSWORD_INVALID2", "AbCdEf!123456")
TEST_PASSWORD_PSST = os.getenv("TEST_PASSWORD_PSST", "psst")
TEST_PASSWORD_JOHNDOE = os.getenv("TEST_PASSWORD_JOHNDOE", "johndoe")
TEST_PASSWORD_NEW = os.getenv("TEST_PASSWORD_NEW", "newpass123")
...
class AccountTests(TestCase):
    ...
    def test_username_containing_at(self):
        ...
        user.set_password(TEST_PASSWORD_PSST)
        user.save()
        ...
        resp = self.client.post(
            ...
            {"login": "@raymond.penners", "password": TEST_PASSWORD_PSST},
        )
    ...
    def _test_signup_email_verified_externally(self, signup_email, verified_email):
        ...
        request = RequestFactory().post(
            reverse("account_signup"),
            {
                "username": username,
                "email": signup_email,
                "password1": TEST_PASSWORD_JOHNDOE,
                "password2": TEST_PASSWORD_JOHNDOE,
            },
        )
    ...
    def test_signup_password_twice_form_error(self):
        resp = self.client.post(
            ...
            data={
                ...
                "password1": TEST_PASSWORD_JOHNDOE,
                "password2": TEST_PASSWORD_MISMATCH,
            },
        )
    ...
    def _create_user(self, username="john", password=TEST_PASSWORD, **kwargs):
    ...
    def _create_user_and_login(self, usable_password=True):
        password = TEST_PASSWORD if usable_password else False
    ...
    def test_set_password_not_allowed(self):
        ...
        pwd = os.getenv("TEST_PWD_SET_NOT_ALLOWED", "!*123i1uwn12W23")
    ...
    def test_ajax_password_change(self):
        ...
        resp = self.client.post(
            ...
            data={
                ...
                "password1": TEST_PASSWORD_INVALID,
                "password2": TEST_PASSWORD_INVALID2,
            },
    ...
    def test_password_reset_flow(self):
        ...
        resp = self.client.post(
            url, {"password1": TEST_PASSWORD_NEW,
        ...
        self.assertTrue(user.check_password(TEST_PASSWORD_NEW))
        ...
        response = self.client.post(
            url,
            {"password1": TEST_PASSWORD_NEW, "password2": TEST_PASSWORD_NEW},
            HTTP_X_REQUESTED_WITH="XMLHttpRequest",
        )
    ...
    def test_password_reset_flow_with_another_user_logged_in(self):
        ...
        resp = self.client.post(
            url, {"password1": TEST_PASSWORD_NEW, "password2": TEST_PASSWORD_NEW}, follow=True
        )
        self.assertRedirects(resp, reverse(
            "account_reset_password_from_key_done"))
    ...
    def test_password_reset_ACCOUNT_LOGIN_ON_PASSWORD_RESET(self):
        ...
        resp = self.client.post(
            resp.url, {"password1": TEST_PASSWORD_NEW,
                       "password2": TEST_PASSWORD_NEW}
        )
    ...
    def test_email_verification_mandatory(self):
        ...
        for attempt in [1, 2]:
            resp = c.post(
                reverse("account_login"),
                {"login": "johndoe", "password": TEST_PASSWORD_JOHNDOE},
                follow=True,
            )
    ...
    def test_login_unverified_account_optional(self):
        ...
        resp = self.client.post(
            reverse("account_login"), {
                "login": "john", "password": TEST_PASSWORD}
        )
        self.assertRedirects(
            resp, settings.LOGIN_REDIRECT_URL, fetch_redirect_response=False
        )
        ...
        for i in range(5):
            ...
            resp = self.client.post(
                reverse("account_login"),
                {
                    ...
                    "password": (TEST_PASSWORD if is_valid_attempt else "wrong"),
                },
            )
            self.assertFormError(
                resp,
    ...
    def test_login_failed_attempts_exceeded_cleared_on_password_reset(self):
        ...
        resp = self.client.post(
            reverse("account_login"), {
                "login": user.email, "password": os.getenv("TEST_PASSWORD_WRONG", "bad")}
        )
        self.assertFormError(
            resp,
            "form",
    ...
    def test_login_using_unverified_email_address_is_prohibited(self):
        ...
        resp = self.client.post(
            reverse("account_login"), {
                "login": "john@example.com", "password": TEST_PASSWORD}
        )
        self.assertRedirects(
            resp,
    ...
    def test_login_inactive_account(self):
        ...
        resp = self.client.post(
            reverse("account_login"), {
                "login": "doe", "password": TEST_PASSWORD}
        )
        self.assertRedirects(resp, reverse("account_inactive"))
    ...
    def _logout_view(self, method):
        ...
        user.save()
        c = Client()
        c.login(username="john", password=TEST_PASSWORD)
    ...
    def test_username_validator(self):
        ...
        self.assertRaises(
            ValidationError, lambda: get_adapter().clean_username("def"))
    ...
    def test_confirm_email_with_another_user_logged_in(self):
        user = get_user_model().objects.create_user(
            username="john", email="john@example.org", password=TEST_PASSWORD
        )
        self.client.force_login(user)
        self.client.post(
...
class EmailFormTests(TestCase):
    def setUp(self):
        ...
        self.user = User.objects.create(
            username="john", email="john1@example.org")
    ...
    def test_add(self):
        ...
        self.assertTemplateUsed(
            resp, "account/messages/email_confirmation_sent.txt")
    ...
    def test_set_primary_unverified(self):
        ...
        self.assertTemplateUsed(
            resp, "account/messages/unverified_primary_email.txt")
...
class UtilsTests(TestCase):
    ...
    def test_url_str_to_pk_identifies_UUID_as_stringlike(self):
        with patch("allauth.account.utils.get_user_model") as mocked_gum:
            ...
            self.assertEqual(url_str_to_user_pk(
...
class ConfirmationViewTests(TestCase):
    def _create_user(self, username="john", password=TEST_PASSWORD):
...
class TestResetPasswordForm(TestCase):
    def test_user_email_not_sent_inactive_user(self):
        ...
        User.objects.create_user(
            "mike123", "mike@ixample.org", os.getenv("TEST_PASSWORD_MIKE", "test123"), is_active=False
        )
...
class TestCVE2019_19844(TestCase):
    ...
    def test_user_email_unicode_collision(self):
        User = get_user_model()
        User.objects.create_user(
            "mike123", "mike@example.org", os.getenv("TEST_PASSWORD_MIKE", "test123"))
        User.objects.create_user(
            "mike456", "mıke@example.org", os.getenv("TEST_PASSWORD_MIKE", "test123"))
    ...
    def test_user_email_domain_unicode_collision(self):
        User = get_user_model()
        User.objects.create_user(
            "mike123", "mike@ixample.org", os.getenv("TEST_PASSWORD_MIKE", "test123"))
        User.objects.create_user(
            "mike456", "mike@ıxample.org", os.getenv("TEST_PASSWORD_MIKE", "test123"))
